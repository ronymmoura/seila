...
func TestUserRepository_FindByUsername(t *testing.T) {
	user, err := repository.FindByUsername(context.Background(), "ronymmoura")
...
func TestUserRepository_FindByUsernameNotFound(t *testing.T) {
	user, err := repository.FindByUsername(context.Background(), "a")
	require.Error(t, err)
