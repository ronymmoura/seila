    ...
    <Modal>
      <section className="flex flex-col">
        ...
        <div className="my-2">
          ...
          <input className="input" value={BillDescription} onChange={(e) => setBillDescription(e.target.value)} />
        </div>

        <div className="my-2">
          <label>Data</label>
          <Input type="date" className="input" value={BillDate} onChange={(e) => setBillDate(e.formattedValue)} />
        </div>

        <div className="my-2">
          <label>Valor</label>
          <Input type="money" className="input" value={BillValue} onChange={(e) => setBillValue(e.floatValue)} />
        </div>
